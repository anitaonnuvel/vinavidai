...
public final class AhpExceptionTranslator {
    ...
    public static AhpRuntimeException newException( Class pClass,
            Throwable pThrowable, String pExceptionResourceKey,
            Object[] pExceptionResourceArguments ) {
        try {
            Constructor lConstructor = pClass.getConstructor( String.class,
                    Throwable.class );
            AhpRuntimeException lAhpRuntimeException = ( AhpRuntimeException ) lConstructor
                    .newInstance( "", pThrowable );
    ...
    public static AhpRuntimeException newException( Throwable pThrowable,
            String pExceptionResourceKey, Object[] pExceptionResourceArguments ) {
        return newException( AhpRuntimeException.class, pThrowable,
                pExceptionResourceKey, pExceptionResourceArguments );
    }

    public static void main( String[] pArgs ) {
        AhpExceptionTranslator.newException( AhpRuntimeException.class,
                new RuntimeException(), "AHP.001.0001", null );
    }
