...
public final class AhpXPathUtil {
	 ...
	 *
	 * @param pNamespaceContext the new namespace context
	 */
	 ...
	 *
	 * @param pXPathVariableResolver the new x path variable resolver
	 */
	 ...
	 *
	 * @param pXPathFunctionResolver the new x path function resolver
	 */
