                            ...
                            <html:form action="${form.processAction}" method="post">
                                <table id="ahpFormTablePlain">
                                    ...
                                    <logic:iterate name="${form.formName}"
                                        ...
                                        length="1">
                                        <tr>
                                            <td><strong>Select an Answer*</strong></td>
                                            <td>
	                                            <label><html:radio name="option" property="answer" value="true" indexed="true"/>True</label><br>
	                                            <label><html:radio name="option" property="answer" value="false" indexed="true"/>False</label>
                                            </td>
                                        </tr>    
                                    </logic:iterate>
                                </table>
                                <html:hidden name="${form.formName}" property="questionType" value="TrueOrFalse"></html:hidden>
                                <div id="formSubmit">
