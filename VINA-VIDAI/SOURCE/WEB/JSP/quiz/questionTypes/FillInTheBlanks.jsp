                            ...
                            <html:form action="${form.processAction}" method="post">
                                <table id="ahpFormTablePlain">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="helperText">Please use the below format:<br>Earth is between $Venus and $Mars.<br>It will appear for the Quiz taker like<br>Earth is between _____ and _____<span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                ...
                                <html:hidden name="${form.formName}" property="questionType" value="FillInTheBlanks"></html:hidden>
                                <div id="formSubmit">
