...
<html>
    <head>
        ...
        <title>VinaVidai - Manage Quiz - ${sessionScope.LOGGED_IN_USER.loginName}</title>
        <script type="text/javascript">
            ...
            function viewQuiz(val){
            	<%-- document.getElementById('hiddenSelectedItemId').value = val--%>
            ...
            <div id="bodyContent">                               
                ...
                <html:form action="${form.processAction}" method="post">
                    <table id="ahpPaginationTable">
                        ...
                        <%--
                        List<Quiz> lQuizResults = new ArrayList<Quiz>();
                        Iterator<Quiz> lQuizterator = lQuizResults.iterator();
                        while ( lQuizterator.hasNext() ){
                            Quiz lQuiz = lQuizterator.next();
                        }         
                        --%>
                        <logic:iterate name="${form.formName}"
                            ...
                            <td>
                               ...
                               <%-- <html:link href="#" onclick="viewQuiz(${quiz.quizId});"><bean:write name="quiz" property="quizName"/></html:link>--%>
                            </td>
                            <td>
                    ...
                    <div id="formSubmit">
                        <span id="manageToolBarRight" style="float:right">
                            <html:submit property="submitAction" value="Edit" styleId="Edit" styleClass="submitButton"/>
                            <html:submit property="submitAction" value="Publish" styleId="Publish" styleClass="submitButton"/>
                            <html:submit property="submitAction" value="Reports" styleId="Reports" styleClass="submitButton"/>
                            &nbsp;&nbsp;
                            <html:submit property="submitAction" value="Delete" styleId="Delete" styleClass="submitButton"/>
                        </span>
                        <span class="ahpHyperLinkBox" style="float:left">                            
                            <html:link action="ProcessQuizConsole.do">Return to Console</html:link>
                        </span>
                    </div>
                    <br/>
                    <br/>
