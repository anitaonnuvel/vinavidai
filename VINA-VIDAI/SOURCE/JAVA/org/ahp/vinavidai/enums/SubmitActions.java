...
public enum SubmitActions {
	...
	COMPLETE("Complete"), 
	RESET("Reset"), 
	RETURN_TO_CONSOLE( "Return To Console"), 
	RETURN_TO_MANAGE_QUIZ("Return To Manage Quiz"), 
	CONFIRM_DELETE(	"Confirm Delete"), 
	DELETE( "Delete" ), 
	EDIT( "Edit" ), 
	ADD_QUESTIONS(
			"Add Questions"), 
			SAVE_AND_ADD_QUESTIONS("Save and Add Questions"), PUBLISH(
			"Publish"), 
			PUBLISH_TEST("Publish Test"), 
			PUBLISH_QUIZ(
			"Publish Quiz"), REPORTS("Reports"), VIEW_QUIZ("View Quiz"), SAVE_CHANGES(
			"Save Changes"), EMPTY(""), ADD_CATEGORY("Add Category"), DELETE_CATEGORY(
