 ...
 * 
 * @struts.action path="/DisplayQuizConsole" name="QuizConsoleForm"
 *                scope="session" validate="false"
 * 
 * @struts.action-forward name="DisplayQuizConsole"
 *                        path="/console/QuizConsole.jsp"
 * 
 * @spring.bean name="/DisplayQuizConsole"
 * 
 * @spring.property name="quizService" ref="quizService"
 */
public class DisplayQuizConsole extends AhpAbstractDisplayAction {

	final static Logger LOGGER = LoggerFactory
			.getLogger(DisplayQuizConsole.class);
	...
	public ActionForward display(ActionMapping pActionMapping,
		...
		String lNextPage = StringUtils.trimToEmpty(lQuizConsoleForm
				.getNextPage());
		ActionForward lActionForward = pActionMapping
				.findForward(NavigateActions.DisplayQuizConsole.toString());
		String lSubmitAction = StringUtils.trimToEmpty(lQuizConsoleForm
				.getSubmitAction());
