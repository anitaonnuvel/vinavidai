 ...
 */
package org.ahp.vinavidai.test.form;
 ...
 * 
 * @struts.form name="TakeTestForm"
 */
public class TakeTestForm extends AhpAbstractForm {

    private static final long serialVersionUID = 1L;

    final static Logger LOGGER = LoggerFactory.getLogger( TakeTestForm.class );

    private Test mTakeTest;
    ...
    public Test getTakeTest() {
        return mTakeTest;
    }

    public void setTakeTest( Test pTakeTest ) {
        mTakeTest = pTakeTest;
    }
