 ...
 * 
 * @struts.form name="EditQuestionForm"
 */
public class EditQuestionForm extends QuestionForm {

    private static final long serialVersionUID = 1L;

    final static Logger LOGGER = LoggerFactory
            .getLogger( EditQuestionForm.class );
    ...
    public ActionErrors validate( ActionMapping pActionMapping,
        ...
        if ( lSubmitAction != null ) {
            if ( lSubmitAction.equals( SubmitActions.CONTINUE.toString() )
                ...
                QuestionValidator
                        .validateEditQuestionForm( this, lActionErrors );
            }
